...
function initBot(){
    ...
    botui.message.bot({delay:500,loading:!0,content:"Hi! Our coronavirus disease self assessment scan has been developed on the basis of guidelines from the WHO and MHFW. This interaction should not be taken as expert medical advice. Any information you share with us will be kept strictly confidential."}).then(()=>{
...
return botui.message.bot({delay:500,loading:!0,content:"Do you have cold?"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"No",value:"0"},{text:"Yes",value:"1"}]})}).then(res=>{inputObj.cold=res.value;inputObj.coldText=res.text;point+=Number(res.value);
...
return botui.message.bot({delay:500,loading:!0,content:"Do you have a headache?"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"No",value:"0"},{text:"Yes",value:"1"}]})}).then(res=>{inputObj.headache=res.value;inputObj.headacheText=res.text;point+=Number(res.value);  
return botui.message.bot({delay:500,loading:!0,content:"Do you have fever (Temperature 37.8 C or Fahrenheit 100.04 above)"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"No",value:"0"},{text:"Yes",value:"1"}]})}).then(res=>{inputObj.fever=res.value;inputObj.feverText=res.text;point+=Number(res.value);
return botui.message.bot({delay:500,loading:!0,content:"Are you having difficulty in breathing?"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"No",value:"0"},{text:"Yes",value:"2"}]})}).then(res=>{inputObj.breathing=res.value;inputObj.breathingText=res.text;point+=Number(res.value);
...
return botui.message.bot({delay:500,loading:!0,content:"Do you have a travel history to a COVID-19 INFECTED AREA?"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"No",value:"0"},{text:"Yes",value:"3"}]})}).then(res=>{inputObj.travelArea=res.value;inputObj.travelAreaText=res.text;point+=Number(res.value);
...
function showScore(){let body=document.getElementsByTagName("body")[0];body.classList.add("loading");return new Promise(function(resolve,reject){
    ...
    setTimeout(()=>{body.classList.remove("loading");
        window.location.href=domain+"/info?score="+point;
